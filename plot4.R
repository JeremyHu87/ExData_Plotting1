...
plot(TimeLine,as.numeric(PowerCon1$Global_active_power),type="l", xlab="", ylab="Global Active Power")

plot(TimeLine,as.numeric(PowerCon1$Voltage),type="l", xlab="", ylab="Voltage")
...
plot(TimeLine,as.numeric(PowerCon1$Global_reactive_power),type="l", xlab="", ylab="Global_reactove_power")
